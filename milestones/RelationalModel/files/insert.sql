 ...
 INSERT INTO `Customer Address` (address_id, number, street, city, state, zip, country)
 ...
 INSERT INTO `Account`(account_id, password, account_type)
 VALUE (1, 'coolguy', 'Customer'),
	   (2, 'nice23', 'Customer'),
       (3, 'wow', 'Customer'),
       (4, 'nice', 'Employee');
       
INSERT INTO `Credit Card Type`(cc_type_id, billing_address, billing_city,billing_state,
...
INSERT INTO `Credit Card` (cc_it, cc_number, expiration_date, CCV, cc_type_id)
...
-- Table `Service Shop`
-- -----------------------------------------------------
INSERT INTO `Service Shop` (service_shop_id, email, phone)
VALUE (111, 'serviceshop@yahoo.com', '510-654-5423');

-- -----------------------------------------------------
-- Table `Dealership Address`
-- -----------------------------------------------------
INSERT INTO `Dealership Address` (Address_id, street, city, state)
VALUE (22, '4599 Stevens Creek Blvd', 'San Jose', 'CA');

-- -----------------------------------------------------
-- Table `Finance Plan`
-- -----------------------------------------------------
INSERT INTO `Finance Plan`(Plan_id, effective_date, term, amount)
...
-- Table `Car Engine`
-- -----------------------------------------------------
INSERT INTO `Car Engine`(engine_id, price) 
...
-- Table `Car Type`
-- -----------------------------------------------------
INSERT INTO `Car Type` (type_id, car_type)
...
-- Table `Car Part`
-- -----------------------------------------------------
INSERT INTO `Car Part`(part_id, car_type, Price) 
